...
1. **Match the effect to the lightest tool** (`_frontend-motion-3d/reference/stack.md` has the
   full table):
...
- `_frontend-motion-3d/reference/stack.md` — effect → tool table, three.js/R3F setup rules,
