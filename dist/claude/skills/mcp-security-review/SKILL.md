...
2. **Run the scanner.**
   ...
   ```
   python3 skills/mcp-security-review/scripts/mcp_scan.py
   ```
...
3. **Manually review tool descriptions for every flagged (or new)
   ...
   just what the tool claims to do. See `reference/threats.md` for the
...
- `reference/threats.md` — threat model (tool poisoning, rug-pull
