...
| `ext-cli-ops` | 0.1.0 | Bootstrap the pinned jfrog/boost CLI for token/CLI operations tooling. Use when the user asks about jfrog Boost specifically, or wants token-usage/CLI-ops tooling this repo doesn't already provide. |
